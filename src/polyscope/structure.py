...
class Structure:
    ...
    def set_transform_mode_gizmo(self, mode: int):
        return self.bound_instance.set_transform_mode_gizmo(mode)
    ...
    def add_color_image_quantity(
        self, name, values, image_origin="upper_left", **option_args
    ):
        """
        Add a "floating" image quantity to the structure
        """
    ...
    def add_raw_color_render_image_quantity(
        self, name, depth_values, color_values, image_origin="upper_left", **option_args
    ):
        """
        Add a "floating" render image quantity to the structure
        """

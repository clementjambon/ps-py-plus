...
class SurfaceMesh(Structure):
    ...
    def append_pick_data(self, pick_result):
        ...
        pick_result.structure_data["element_type"] = enum_to_str(
    ...
    def set_all_permutations(
        self,
        vertex_perm=None,
        vertex_perm_size=None,  # now ignored
        face_perm=None,
        face_perm_size=None,  # now ignored
        edge_perm=None,
        edge_perm_size=None,
        corner_perm=None,
    ...
    def add_vector_quantity(
        self, name, values, defined_on="vertices", vectortype="standard", **vector_args
    ):
        ...
        **vector_args,
        ...
        if defined_on == "vertices":
            ...
            q = self.bound_instance.add_vertex_tangent_vector_quantity(
                name, values, basisX, basisY, n_sym, str_to_vectortype(vectortype)
            )
